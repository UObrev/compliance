...
- Led QA and due diligence programs, including inspection protocols, process validation, and audit readiness  
- Developed digital training and e-learning modules to reinforce compliance procedures and SOP adherence  
- Supported documentation control, digital traceability, and regulatory compliance across device operations  
...
- Defined compliant HCP engagement standards, including controls on improper inducements and documentation  
- Partnered with Legal and Medical to implement compliance frameworks and digital training programs  
- Integrated approved, evidence-based messaging into e-detailing tools for compliant execution  
...
- Ensured messaging adhered to approved indications and no off-label promotion  
- Leveraged e-detailing tools to improve compliance, consistency, and auditability  
- Strengthened monitoring and governance across cardiovascular products  
...
- Managed internal budget controls and financial governance  
...
- Directed budget planning and internal compliance processes  
- Managed corporate legal functions and regulatory alignment  
